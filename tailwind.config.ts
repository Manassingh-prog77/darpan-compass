  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        dispute: {
          DEFAULT: "hsl(var(--dispute))",
          foreground: "hsl(var(--dispute-foreground))",
        },
        navy: {
      ...
      keyframes: {
        ...
        "pulse-ring": { "0%": { transform: "scale(0.95)", opacity: "1" }, "100%": { transform: "scale(1)", opacity: "0.7" } },
      },
      animation: {
        ...
        "pulse-ring": "pulse-ring 2s ease-in-out infinite alternate",
      },
    },
  },
